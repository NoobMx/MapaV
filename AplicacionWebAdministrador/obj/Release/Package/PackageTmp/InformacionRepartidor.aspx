...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="Page_Seleccion">
            ...
            <h2 class="Titulo-Pagina">Información del Repartidor</h2>
        </div>
        <div class="Contenido">
            ...
            <div class="Contendor-Informacion_Repartidor">
                <form ID="fomr1" runat="server" class="Info-Repartidor">
                    ...
                    <div class="Area-Añadir">
                        <asp:Button class="Añadir" type="submit" runat="server" Text="Cambiar Estatus" OnClick="Desactivar"/>
                    </div>
                </form>   
