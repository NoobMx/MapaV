<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasMaestras/Layout.Master" AutoEventWireup="true" CodeBehind="AgregarProducto.aspx.cs" Inherits="AplicacionWebAdministrador.AgregarProducto" %>
            ...
            <div class="Formulario-Imagenes ">
                <form class="Formulario formulario" ID="FormularioNuevoProducto" runat="server">
                    ...
                    <div class="Area-Stock">
                        <h3>Cantidad a vender:</h3>
                        <span><i class="fa-solid fa-list"></i></span>
                        <asp:TextBox class="Stock" type="number" ID="Txt_stock" runat="server" value="0"></asp:TextBox>
                    </div>
                    <div class="Area-Añadir">
                        <asp:Button class="Añadir" type="submit" runat="server" Text="Agregar al carrito" OnClick ="ActualizarStock"/>
                    </div>
                </form>     
